...
async function updateData() {
  ...
  const prompt = 'Generate a JSON object with the following EXACT structure. ' +
    ...
    '}, ' +
    '"cafe": [ { "name": "카페명", "name_en": "Cafe Name", "lat": 37.0, "lng": 127.0, "address": "도로명 주소", "feature": "아이 동반 특징", "feature_en": "Kid-friendly feature", "parking": "주차 정보" } ] (6 items total), ' +
    '"health": { ' +
